...
| **R3** | ADR obligatoire            | At least one ADR in `docs/adrs/NNNN-*.md` format               |
| **R4** | Cohérence documentation    | AI review validates doc/code alignment                         |

### Pre-Implementation Checklist

- [ ] Identify which ADR(s) this feature requires
- [ ] Determine correct layer placement (domain/application/infrastructure)
- [ ] Verify no architectural violations will be introduced
