...
<!--
  This section is automatically populated based on .spec-kit/governance.md
  and .specify/memory/governance-rules.md

  ⚠️ These requirements are MANDATORY for PR merge.
-->
...
- [ ] **GR-004**: An ADR MUST be created documenting the key decision(s) for this feature
  - ADR Path: `docs/adrs/NNNN-[feature-name].md`
